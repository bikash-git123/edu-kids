...
<div class="page-header">
  <h3 class="fw-bold mb-3">Add New Course</h3>
        ...
        <form action="{{ route('admin.courses.store') }}" method="POST">
          ...
          <div class="row g-3">
            <div class="col-md-4">
              ...
              <input type="text" name="code" id="code" class="form-control" placeholder="e.g. CS-101" value="{{ old('code') }}" required>
            </div>
            <div class="col-md-8">
              <label for="name" class="form-label fw-bold">Course Title <span class="text-danger">*</span></label>
              <input type="text" name="name" id="name" class="form-control" placeholder="e.g. Introduction to Programming" value="{{ old('name') }}" required>
            </div>
            ...
            <div class="col-md-4">
              ...
              <input type="number" name="credits" id="credits" class="form-control" min="1" max="10" value="{{ old('credits', 3) }}" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-12">
              ...
              <textarea name="description" id="description" class="form-control" rows="4" placeholder="Brief outline of course objectives, syllabus, and prerequisites...">{{ old('description') }}</textarea>
            </div>
          </div>
